...
!function (a) {
  var b = function () {
    ...
    return a.prototype.toString = function () {
      ...
      var e = b.r + (c.r - b.r) * d, f = b.g + (c.g - b.g) * d, g = b.b + (c.b - b.b) * d;
      return new a(e, f, g)
    }, a.Red = function () {
      return new a(1, 0, 0)
    }, a.Green = function () {
  ...
  var d = function () {
    ...
    return a.prototype.toString = function () {
      ...
      var g = f * f, h = f * g, i = .5 * (2 * c.x + (-b.x + d.x) * f + (2 * b.x - 5 * c.x + 4 * d.x - e.x) * g + (-b.x + 3 * c.x - 3 * d.x + e.x) * h), j = .5 * (2 * c.y + (-b.y + d.y) * f + (2 * b.y - 5 * c.y + 4 * d.y - e.y) * g + (-b.y + 3 * c.y - 3 * d.y + e.y) * h);
      return new a(i, j)
      ...
      var g = f * f, h = f * g, i = 2 * h - 3 * g + 1, j = -2 * h + 3 * g, k = h - 2 * g + f, l = h - g, m = b.x * i + d.x * j + c.x * k + e.x * l, n = b.y * i + d.y * j + c.y * k + e.y * l;
      return new a(m, n)
    }, a.Lerp = function (b, c, d) {
      var e = b.x + (c.x - b.x) * d, f = b.y + (c.y - b.y) * d;
      return new a(e, f)
    }, a.Dot = function (a, b) {
      ...
      var d = b.x < c.x ? b.x : c.x, e = b.y < c.y ? b.y : c.y;
      return new a(d, e)
    }, a.Maximize = function (b, c) {
      var d = b.x > c.x ? b.x : c.x, e = b.y > c.y ? b.y : c.y;
      return new a(d, e)
    }, a.Transform = function (b, c) {
      var d = b.x * c.m[0] + b.y * c.m[4], e = b.x * c.m[1] + b.y * c.m[5];
      return new a(d, e)
  ...
  var e = function () {
    ...
    return b.prototype.toString = function () {
      ...
      var d = a.x * b.m[0] + a.y * b.m[4] + a.z * b.m[8] + b.m[12], e = a.x * b.m[1] + a.y * b.m[5] + a.z * b.m[9] + b.m[13], f = a.x * b.m[2] + a.y * b.m[6] + a.z * b.m[10] + b.m[14], g = a.x * b.m[3] + a.y * b.m[7] + a.z * b.m[11] + b.m[15];
      c.x = d / g, c.y = e / g, c.z = f / g
    }, b.TransformCoordinatesFromFloatsToRef = function (a, b, c, d, e) {
      var f = a * d.m[0] + b * d.m[4] + c * d.m[8] + d.m[12], g = a * d.m[1] + b * d.m[5] + c * d.m[9] + d.m[13], h = a * d.m[2] + b * d.m[6] + c * d.m[10] + d.m[14], i = a * d.m[3] + b * d.m[7] + c * d.m[11] + d.m[15];
      ...
      var g = f * f, h = f * g, i = .5 * (2 * c.x + (-a.x + d.x) * f + (2 * a.x - 5 * c.x + 4 * d.x - e.x) * g + (-a.x + 3 * c.x - 3 * d.x + e.x) * h), j = .5 * (2 * c.y + (-a.y + d.y) * f + (2 * a.y - 5 * c.y + 4 * d.y - e.y) * g + (-a.y + 3 * c.y - 3 * d.y + e.y) * h), k = .5 * (2 * c.z + (-a.z + d.z) * f + (2 * a.z - 5 * c.z + 4 * d.z - e.z) * g + (-a.z + 3 * c.z - 3 * d.z + e.z) * h);
      return new b(i, j, k)
      ...
      var g = f * f, h = f * g, i = 2 * h - 3 * g + 1, j = -2 * h + 3 * g, k = h - 2 * g + f, l = h - g, m = a.x * i + d.x * j + c.x * k + e.x * l, n = a.y * i + d.y * j + c.y * k + e.y * l, o = a.z * i + d.z * j + c.z * k + e.z * l;
      return new b(m, n, o)
    }, b.Lerp = function (a, c, d) {
      var e = a.x + (c.x - a.x) * d, f = a.y + (c.y - a.y) * d, g = a.z + (c.z - a.z) * d;
      return new b(e, f, g)
    }, b.Dot = function (a, b) {
      ...
      var g = f.width, h = f.height, i = f.x, j = f.y, k = a.Matrix.FromValues(g / 2, 0, 0, 0, 0, -h / 2, 0, 0, 0, 0, 1, 0, i + g / 2, h / 2 + j, 0, 1), l = d.multiply(e).multiply(k);
      ...
      var i = a.Vector3.TransformCoordinates(b, h), j = b.x * h.m[3] + b.y * h.m[7] + b.z * h.m[11] + h.m[15];
  ...
  var f = function () {
    ...
    return a.prototype.toString = function () {
      ...
      var b = this.x, c = this.y, d = this.z, e = this.w, f = b * b, g = c * c, h = d * d, i = Math.atan2(2 * (c * e - b * d), 1 - 2 * (g + h)), j = Math.asin(2 * (b * c + d * e)), k = Math.atan2(2 * (b * e - c * d), 1 - 2 * (f + h)), l = b * c + d * e;
      l > .499 ? (i = 2 * Math.atan2(b, e), k = 0) : -.499 > l && (i = -2 * Math.atan2(b, e), k = 0), a.x = j, a.y = i, a.z = k
    }, a.prototype.toRotationMatrix = function (a) {
      var b = this.x * this.x, c = this.y * this.y, d = this.z * this.z, e = this.x * this.y, f = this.z * this.w, g = this.z * this.x, h = this.y * this.w, i = this.y * this.z, j = this.x * this.w;
      ...
      var b, c = a.m, d = c[0], e = c[4], f = c[8], g = c[1], h = c[5], i = c[9], j = c[2], k = c[6], l = c[10], m = d + h + l;
      ...
      var e = .5 * c, f = .5 * b, g = .5 * a, h = Math.sin(e), i = Math.cos(e), j = Math.sin(f), k = Math.cos(f), l = Math.sin(g), m = Math.cos(g);
      d.x = m * j * i + l * k * h, d.y = l * k * i - m * j * h, d.z = m * k * h - l * j * i, d.w = m * k * i + l * j * h
    }, a.Slerp = function (b, c, d) {
      var e, f, g = d, h = b.x * c.x + b.y * c.y + b.z * c.z + b.w * c.w, i = !1;
      if (0 > h && (i = !0, h = -h), h > .999999)f = 1 - g, e = i ? -g : g; else {
        var j = Math.acos(h), k = 1 / Math.sin(j);
  ...
  var g = function () {
    ...
    return a.prototype.isIdentity = function () {
      ...
      var a = this.m[10] * this.m[15] - this.m[11] * this.m[14], b = this.m[9] * this.m[15] - this.m[11] * this.m[13], c = this.m[9] * this.m[14] - this.m[10] * this.m[13], d = this.m[8] * this.m[15] - this.m[11] * this.m[12], e = this.m[8] * this.m[14] - this.m[10] * this.m[12], f = this.m[8] * this.m[13] - this.m[9] * this.m[12];
      ...
      var d = this.m[0], e = this.m[1], f = this.m[2], g = this.m[3], h = this.m[4], i = this.m[5], j = this.m[6], k = this.m[7], l = this.m[8], m = this.m[9], n = this.m[10], o = this.m[11], p = this.m[12], q = this.m[13], r = this.m[14], s = this.m[15], t = a.m[0], u = a.m[1], v = a.m[2], w = a.m[3], x = a.m[4], y = a.m[5], z = a.m[6], A = a.m[7], B = a.m[8], C = a.m[9], D = a.m[10], E = a.m[11], F = a.m[12], G = a.m[13], H = a.m[14], I = a.m[15];
      ...
      var d = Math.sin(-c), e = Math.cos(-c), f = 1 - e;
      b.normalize();
      var g = a.Zero();
      ...
      var g = -e.Dot(this._xAxis, b), h = -e.Dot(this._yAxis, b), i = -e.Dot(this._zAxis, b);
      ...
      var f = 2 / b, g = 2 / c, h = 1 / (e - d), i = d / (d - e);
      ...
      var h = b.width, i = b.height, j = b.x, k = b.y, l = a.FromValues(h / 2, 0, 0, 0, 0, -i / 2, 0, 0, 0, 0, g - f, 0, j + h / 2, i / 2 + k, f, 1);
      ...
      a.normalize();
      var c = a.normal.x, d = a.normal.y, e = a.normal.z, f = -2 * c, g = -2 * d, h = -2 * e;
  ...
  var h = function () {
    ...
    return b.prototype.asArray = function () {
      ...
      var a = Math.sqrt(this.normal.x * this.normal.x + this.normal.y * this.normal.y + this.normal.z * this.normal.z), b = 0;
      0 != a && (b = 1 / a), this.normal.x *= b, this.normal.y *= b, this.normal.z *= b, this.d *= b
    }, b.prototype.transform = function (b) {
      var c = a.Matrix.Transpose(b), d = this.normal.x, e = this.normal.y, f = this.normal.z, g = this.d, h = d * c.m[0] + e * c.m[1] + f * c.m[2] + g * c.m[3], i = d * c.m[4] + e * c.m[5] + f * c.m[6] + g * c.m[7], j = d * c.m[8] + e * c.m[9] + f * c.m[10] + g * c.m[11], k = d * c.m[12] + e * c.m[13] + f * c.m[14] + g * c.m[15];
      ...
      var d, e = b.x - a.x, f = b.y - a.y, g = b.z - a.z, h = c.x - a.x, i = c.y - a.y, j = c.z - a.z, k = f * j - g * i, l = g * h - e * j, m = e * i - f * h, n = Math.sqrt(k * k + l * l + m * m);
  ...
  var i = function () {
    ...
    return a.prototype.toGlobal = function (b) {
      var c = b.getRenderWidth(), d = b.getRenderHeight();
  ...
  var k = function () {
    ...
    return b.prototype.intersectsBoxMinMax = function (a, b) {
      var c = 0, d = Number.MAX_VALUE;
      if (Math.abs(this.direction.x) < 1e-7) {
        if (this.origin.x < a.x || this.origin.x > b.x)return !1
      } else {
        var e = 1 / this.direction.x, f = (a.x - this.origin.x) * e, g = (b.x - this.origin.x) * e;
        if (f > g) {
          var h = f;
          f = g, g = h
        }
      ...
      var b = a.center.x - this.origin.x, c = a.center.y - this.origin.y, d = a.center.z - this.origin.z, e = b * b + c * c + d * d, f = a.radius * a.radius;
      if (f >= e)return !0;
      ...
      var j = a.Vector3.Unproject(new a.Vector3(c, d, 0), e, f, g, h, i), k = a.Vector3.Unproject(new a.Vector3(c, d, 1), e, f, g, h, i), l = k.subtract(j);
      return l.normalize(), new b(j, l)
    }, b.Transform = function (c, d) {
      var e = a.Vector3.TransformCoordinates(c.origin, d), f = a.Vector3.TransformNormal(c.direction, d);
      return new b(e, f)
    }, b
  }();
  a.Ray = k, function (a) {
...
var BABYLON;
!function (a) {
  var b, c = 60, d = [], e = 60, f = 0, g = function (b, c) {
    ...
    return h.GetFilename = function (a) {
      ...
      if (e && e.enableTexturesOffline && a.Database.isUASupportingBlobStorage)e.openAsync(i, g); else if (-1 === b.indexOf("file:"))g(); else try {
        var j, k = b.substring(5);
        try {
          j = URL.createObjectURL(a.FilesInput.FilesTextures[k], {oneTimeOnly: !0})
        } catch (l) {
      ...
      b = h.CleanUrl(b);
      var i = function () {
        var e = new XMLHttpRequest, i = h.BaseUrl + b;
        e.open("GET", i, !0), f && (e.responseType = "arraybuffer"), e.onprogress = d, e.onreadystatechange = function () {
          if (4 == e.readyState)if (200 == e.status || a.Tools.ValidateXHRData(e, f ? 6 : 1))c(f ? e.response : e.responseText); else {
      ...
      for (var e in a)if (("_" !== e[0] || d && -1 !== d.indexOf(e)) && (!c || -1 === c.indexOf(e))) {
        var f = a[e], h = typeof f;
        if ("function" != h)if ("object" == h)if (f instanceof Array) {
          if (b[e] = [], f.length > 0)if ("object" == typeof f[0])for (var i = 0; i < f.length; i++) {
            var j = g(f[i], b);
            -1 === b[e].indexOf(j) && b[e].push(j)
          } else b[e] = f.slice(0)
        } else b[e] = g(f, b); else b[e] = f
      }
      ...
      if (i.activeCamera !== d && (j = i.activeCamera, i.activeCamera = d), e.precision)f = Math.round(c.getRenderWidth() * e.precision), g = Math.round(f / c.getAspectRatio(d)), e = {
        width: f,
        height: g
      }; else if (e.width && e.height)f = e.width, g = e.height; else if (e.width && !e.height)f = e.width, g = Math.round(f / c.getAspectRatio(d)), e = {
        width: f,
        height: g
      ...
      k.renderList = c.scenes[0].meshes, k.onAfterRender = function () {
        for (var a = 4 * f, d = g / 2, e = c.readPixels(0, 0, f, g), h = 0; d > h; h++)for (var i = 0; a > i; i++) {
          var j = i + h * a, k = g - h - 1, l = i + k * a, m = e[j];
          e[j] = e[l], e[l] = m
        }
        b || (b = document.createElement("canvas")), b.width = f, b.height = g;
        var n = b.getContext("2d"), o = n.createImageData(f, g);
        o.data.set(e), n.putImageData(o, 0, 0);
        var p = b.toDataURL();
        if ("download"in document.createElement("a")) {
          var q = window.document.createElement("a");
          q.href = p;
          var r = new Date, s = r.getFullYear() + "/" + r.getMonth() + "/" + r.getDate() + "-" + r.getHours() + ":" + r.getMinutes();
          ...
          var t = window.open(""), u = t.document.createElement("img");
    ...
    }, h._LogDisabled = function () {
    }, h._LogEnabled = function (a) {
      console.log(h._FormatMessage(a))
    }, h._WarnDisabled = function () {
    }, h._WarnEnabled = function (a) {
      console.warn(h._FormatMessage(a))
    }, h._ErrorDisabled = function () {
    }, h._ErrorEnabled = function (a) {
...
!function (a) {
  ...
  var d = function (a, b, c, d) {
    ...
    var m = d.getEngine(), n = a.Tools.GetExponantOfTwo(f, m.getCaps().maxTextureSize), o = a.Tools.GetExponantOfTwo(g, m.getCaps().maxTextureSize);
  ...
  var i = function () {
    ...
    return Object.defineProperty(i, "ALPHA_DISABLE", {
      ...
      var d = b || this._renderingCanvas.width, e = c || this._renderingCanvas.height, f = a.x || 0, g = a.y || 0;
      ...
      var j = b.vertexElement || b.vertex || b, k = b.fragmentElement || b.fragment || b, l = j + "+" + k + "@" + f;
      ...
      var e = d(this._gl, a, "vertex", c), f = d(this._gl, b, "fragment", c), g = this._gl.createProgram();
      ...
      if (q) {
        var s = function (b) {
          var i = new Uint8Array(b), j = a.Internals.TGATools.GetTGAHeader(i);
        ...
        var s = function (b) {
          var i = a.Internals.DDSTools.GetDDSInfo(b), j = (i.isRGB || i.isLuminance || i.mipmapCount > 1) && !c && i.width >> i.mipmapCount - 1 == 1;
      ...
      var d = !1, f = !0, g = a.Texture.TRILINEAR_SAMPLINGMODE;
      ...
      var h = this._gl, i = h.createTexture();
      h.bindTexture(h.TEXTURE_2D, i);
      var j = b.width || b, k = b.height || b, l = e(g, d, h);
      ...
      var f = this, h = this._gl, i = h.createTexture();
      i.isCube = !0, i.url = b, i.references = 1, this._loadedTexturesCache.push(i);
      var j = b.substr(b.length - 4, 4).toLowerCase(), k = this.getCaps().s3tc && ".dds" === j;
      return k ? a.Tools.LoadFile(b, function (b) {
        var c = a.Internals.DDSTools.GetDDSInfo(b), d = (c.isRGB || c.isLuminance || c.mipmapCount > 1) && !e;
        ...
        var c = a.Tools.GetExponantOfTwo(b[0].width, f._caps.maxCubemapTextureSize), d = c;
      ...
      var d = this._loadedTexturesCache.indexOf(a);
      -1 !== d && this._loadedTexturesCache.splice(d, 1)
      ...
      if (!(0 > b)) {
        ...
        if (c instanceof a.VideoTexture)c.update() && (this._activeTexturesCache[b] = null); else if (c.delayLoadState == a.Engine.DELAYLOADSTATE_NOTLOADED)return void c.delayLoad();
...
!function (a) {
  var b = function () {
    ...
    }, b.prototype._updateCache = function () {
    }, b.prototype._isSynchronized = function () {
      return !0
...
!function (a) {
  var b = function () {
    ...
    return b.prototype._update = function (b) {
      ...
      for (var b = 0; 6 > b; b++)if (a[b].dotCoordinate(this.centerWorld) <= -this.radiusWorld)return !1;
      return !0
    }, b.prototype.intersectsPoint = function (b) {
      var c = this.centerWorld.x - b.x, d = this.centerWorld.y - b.y, e = this.centerWorld.z - b.z, f = Math.sqrt(c * c + d * d + e * e);
      return Math.abs(this.radiusWorld - f) < a.Engine.Epsilon ? !1 : !0
    }, b.Intersects = function (a, b) {
      var c = a.centerWorld.x - b.centerWorld.x, d = a.centerWorld.y - b.centerWorld.y, e = a.centerWorld.z - b.centerWorld.z, f = Math.sqrt(c * c + d * d + e * e);
...
!function (a) {
  var b = function () {
    ...
    return b.prototype.getWorldMatrix = function () {
      ...
      var f = a.Vector3.Clamp(d, b, c), g = a.Vector3.DistanceSquared(d, f);
      return e * e >= g
...
!function (a) {
  var b = function (b, c) {
    var d = a.Vector3.Dot(c.center, b), e = Math.abs(a.Vector3.Dot(c.directions[0], b)) * c.extendSize.x, f = Math.abs(a.Vector3.Dot(c.directions[1], b)) * c.extendSize.y, g = Math.abs(a.Vector3.Dot(c.directions[2], b)) * c.extendSize.z, h = e + f + g;
    return {min: d - h, max: d + h}
  }, c = function (a, b, c, d) {
    return !(a > d || c > b)
  }, d = function (a, d, e) {
    var f = b(a, d), g = b(a, e);
    ...
    return b.prototype._update = function (a) {
      ...
      if (!c)return !0;
      var e = this.boundingBox, f = b.boundingBox;
...
!function (a) {
  var b = function (b) {
    ...
    }, c.prototype.transferToEffect = function () {
...
!function (a) {
  var b = function () {
    function b(c, d) {
      ...
      var f = function (b) {
        var c = b.getRenderingMesh(), d = e._scene, f = d.getEngine();
        ...
        if (!g.mustReturn) {
          ...
          if (e.isReady(b, h)) {
            ...
            if (k && e._effect.setMatrices("mBones", c.skeleton.getTransformMatrices()), h)c._renderWithInstances(b, !1, g, e._effect, f); else if (g.renderSelf[b._id] && (e._effect.setMatrix("world", c.getWorldMatrix()), c._draw(b, !0)), g.visibleInstances[b._id])for (var l = 0; l < g.visibleInstances[b._id].length; l++) {
      ...
      this._shadowMap.customRenderFunction = function (a, b, c) {
        ...
        if (e._transparencyShadow)for (d = 0; d < c.length; d++)f(c.data[d])
      }
    }
    ...
    return Object.defineProperty(b, "FILTER_NONE", {
      ...
      var e = [a.VertexBuffer.PositionKind], f = b.getMesh(), g = b.getMaterial();
      ...
      var b = this._light.position, c = this._light.direction;
...
!function (a) {
  var b = function (a, b, c, d) {
    ...
    var e = b * b - 4 * a * c, f = {root: 0, found: !1};
    if (0 > e)return f;
    var g = Math.sqrt(e), h = (-b - g) / (2 * a), i = (-b + g) / (2 * a);
    if (h > i) {
      var j = i;
      i = h, h = j
    }
    ...
    return d.prototype._initialize = function (b, c, d) {
      ...
      var g = a.Vector3.Distance(this.basePointWorld, c), h = Math.max(this.radius.x, this.radius.y, this.radius.z);
      ...
      if (d.getMaterial() || j.isFrontFacingTo(this.normalizedVelocity, 0)) {
        var k = j.signedDistanceTo(this.basePoint), l = a.Vector3.Dot(j.normal, this.velocity);
        if (0 == l) {
        ...
        if (i || (this.basePoint.subtractToRef(j.normal, this._planeIntersectionPoint), this.velocity.scaleToRef(h, this._tempVector), this._planeIntersectionPoint.addInPlace(this._tempVector), this._checkPointInTriangle(this._planeIntersectionPoint, e, f, g, j.normal) && (o = !0, p = h, this._collisionPoint.copyFrom(this._planeIntersectionPoint))), !o) {
          var q = this.velocity.lengthSquared(), r = q;
          this.basePoint.subtractToRef(e, this._tempVector);
          var s = 2 * a.Vector3.Dot(this.velocity, this._tempVector), t = this._tempVector.lengthSquared() - 1, u = c(r, s, t, p);
          ...
          var v = this._edge.lengthSquared(), w = a.Vector3.Dot(this._edge, this.velocity), x = a.Vector3.Dot(this._edge, this._baseToVertex);
      ...
      for (var g = d; e > g; g += 3) {
        var h = b[c[g] - f], i = b[c[g + 1] - f], j = b[c[g + 2] - f];
...
!function (a) {
  var b = function (b) {
    ...
    return __extends(c, b), c.prototype._initCache = function () {
    ...
    }, c.prototype.attachControl = function () {
    }, c.prototype.detachControl = function () {
    }, c.prototype._update = function () {
    }, c.prototype.attachPostProcess = function (b, c) {
      ...
      for (f = 0; f < this._postProcessesTakenIndices.length; ++f)if (!(this._postProcessesTakenIndices[f] < c)) {
      ...
      var c = [];
      if (b)for (b = b instanceof Array ? b : [b], f = 0; f < b.length; f++) {
      ...
      } else for (var e = this._postProcesses.length, f = 0; e > f; f++)if (this._postProcesses[f] === a) {
      ...
      var d = c.getRenderWidth() / 2, e = c.getRenderHeight() / 2;
...
!function (a) {
  var b = function (b) {
    ...
    return __extends(c, b), c.prototype._getLockedTargetPosition = function () {
      ...
      var b = this._decideIfNeedsToMove(), c = Math.abs(this.cameraRotation.x) > 0 || Math.abs(this.cameraRotation.y) > 0;
    ...
    return __extends(c, b), c.prototype.attachControl = function (b, c) {
      ...
      this._attachedElement || (this._attachedElement = b, void 0 === this._onMouseDown && (this._onMouseDown = function (a) {
        ...
        if (-1 !== e.keysUp.indexOf(a.keyCode) || -1 !== e.keysDown.indexOf(a.keyCode) || -1 !== e.keysLeft.indexOf(a.keyCode) || -1 !== e.keysRight.indexOf(a.keyCode)) {
          ...
          -1 === b && e._keys.push(a.keyCode), c || a.preventDefault()
        }
      ...
      }, {name: "keyup", handler: this._onKeyUp}, {name: "blur", handler: this._onLostFocus}]))
  ...
  var b = function (b) {
    ...
    return __extends(c, b), c.prototype.attachControl = function (b, c) {
      ...
      this._attachedCanvas || (this._attachedCanvas = b, void 0 === this._onPointerDown && (this._onPointerDown = function (a) {
        ...
        -1 !== b && (e._pointerPressed.splice(b, 1), 0 == b && (d = null, e._offsetX = null, e._offsetY = null))
      ...
      if (this._offsetX)if (this.cameraRotation.y += this._offsetX / this.angularSensibility, this._pointerPressed.length > 1)this.cameraRotation.x += -this._offsetY / this.angularSensibility; else {
        var b = this._computeLocalCameraSpeed(), c = new a.Vector3(0, 0, b * this._offsetY / this.moveSensibility);
...
!function (a) {
  var b = a.Tools.GetPointerPrefix(), c = function (c) {
    ...
    return __extends(d, c), d.prototype._getTargetPosition = function () {
      ...
      if (!this._attachedElement) {
        ...
        void 0 === this._onPointerDown && (this._onPointerDown = function (a) {
          ...
          if (k.isPointerLock && !j) {
            var b = a.movementX || a.mozMovementX || a.webkitMovementX || a.msMovementX || 0, c = a.movementY || a.mozMovementY || a.webkitMovementY || a.msMovementY || 0;
          ...
          if (-1 !== i.keysUp.indexOf(a.keyCode) || -1 !== i.keysDown.indexOf(a.keyCode) || -1 !== i.keysLeft.indexOf(a.keyCode) || -1 !== i.keysRight.indexOf(a.keyCode)) {
            ...
            -1 === b && i._keys.push(a.keyCode), a.preventDefault && (d || a.preventDefault())
          }
        }, this._onKeyUp = function (a) {
          if (-1 !== i.keysUp.indexOf(a.keyCode) || -1 !== i.keysDown.indexOf(a.keyCode) || -1 !== i.keysLeft.indexOf(a.keyCode) || -1 !== i.keysRight.indexOf(a.keyCode)) {
            var b = i._keys.indexOf(a.keyCode);
      ...
      for (var b = 0; b < this._keys.length; b++) {
        var c = this._keys[b];
        -1 !== this.keysLeft.indexOf(c) ? this.inertialAlphaOffset -= .01 : -1 !== this.keysUp.indexOf(c) ? this.inertialBetaOffset -= .01 : -1 !== this.keysRight.indexOf(c) ? this.inertialAlphaOffset += .01 : -1 !== this.keysDown.indexOf(c) && (this.inertialBetaOffset += .01)
      }
      ...
      var b = Math.cos(this.alpha), c = Math.sin(this.alpha), d = Math.cos(this.beta), e = Math.sin(this.beta), f = this._getTargetPosition();
      ...
      var c = a.Mesh.MinMax(b), d = a.Vector3.Distance(c.min, c.max);
      this.radius = d * this.zoomOnFactor, this.focusOn({min: c.min, max: c.max, distance: d})
...
!function (a) {
  var b = function () {
    ...
    return Object.defineProperty(b.prototype, "meshUnderPointer", {
      ...
      var b = this._pendingData.indexOf(a);
      -1 !== b && this._pendingData.splice(b, 1)
      ...
      if (void 0 === f && (f = 1), this.stopAnimation(b), h || (h = new a.Animatable(this, b, c, d, e, f, g)), b.animations && h.appendAnimations(b, b.animations), b.getAnimatables)for (var i = b.getAnimatables(), j = 0; j < i.length; j++)this.beginAnimation(i[j], c, d, e, f, g, h);
      return h
      ...
      for (var b = 0; b < this._activeAnimatables.length; b++)if (this._activeAnimatables[b].target === a)return this._activeAnimatables[b];
      return null
      ...
      for (var b = 0; b < this.materials.length; b++)if (this.materials[b].id === a)return this.materials[b];
      return null
    }, b.prototype.getMaterialByName = function (a) {
      for (var b = 0; b < this.materials.length; b++)if (this.materials[b].name === a)return this.materials[b];
      return null
    }, b.prototype.getCameraByID = function (a) {
      for (var b = 0; b < this.cameras.length; b++)if (this.cameras[b].id === a)return this.cameras[b];
      return null
    }, b.prototype.getCameraByName = function (a) {
      for (var b = 0; b < this.cameras.length; b++)if (this.cameras[b].name === a)return this.cameras[b];
      return null
    }, b.prototype.getLightByName = function (a) {
      for (var b = 0; b < this.lights.length; b++)if (this.lights[b].name === a)return this.lights[b];
      return null
    }, b.prototype.getLightByID = function (a) {
      for (var b = 0; b < this.lights.length; b++)if (this.lights[b].id === a)return this.lights[b];
      return null
    }, b.prototype.getGeometryByID = function (a) {
      for (var b = 0; b < this._geometries.length; b++)if (this._geometries[b].id === a)return this._geometries[b];
      return null
      ...
      for (var b = 0; b < this.meshes.length; b++)if (this.meshes[b].id === a)return this.meshes[b];
      return null
    }, b.prototype.getLastMeshByID = function (a) {
      for (var b = this.meshes.length - 1; b >= 0; b--)if (this.meshes[b].id === a)return this.meshes[b];
      return null
    }, b.prototype.getLastEntryByID = function (a) {
      for (var b = this.meshes.length - 1; b >= 0; b--)if (this.meshes[b].id === a)return this.meshes[b];
      for (b = this.cameras.length - 1; b >= 0; b--)if (this.cameras[b].id === a)return this.cameras[b];
      for (b = this.lights.length - 1; b >= 0; b--)if (this.lights[b].id === a)return this.lights[b];
      return null
    }, b.prototype.getMeshByName = function (a) {
      for (var b = 0; b < this.meshes.length; b++)if (this.meshes[b].name === a)return this.meshes[b];
      return null
    }, b.prototype.getLastSkeletonByID = function (a) {
      for (var b = this.skeletons.length - 1; b >= 0; b--)if (this.skeletons[b].id === a)return this.skeletons[b];
      return null
    }, b.prototype.getSkeletonById = function (a) {
      for (var b = 0; b < this.skeletons.length; b++)if (this.skeletons[b].id === a)return this.skeletons[b];
      return null
    }, b.prototype.getSkeletonByName = function (a) {
      for (var b = 0; b < this.skeletons.length; b++)if (this.skeletons[b].name === a)return this.skeletons[b];
      return null
      ...
      if (this.particlesEnabled)for (var h = 0; h < this.particleSystems.length; h++) {
      ...
      for (var b = 0; b < this._meshesForIntersections.length; b++)for (var c = this._meshesForIntersections.data[b], d = 0; d < c.actionManager.actions.length; d++) {
        ...
        if (e.trigger == a.ActionManager.OnIntersectionEnterTrigger || e.trigger == a.ActionManager.OnIntersectionExitTrigger) {
          var f = e.getTriggerParameter(), g = f.intersectsMesh(c, !1), h = c._intersectionsInProgress.indexOf(f);
          if (g && -1 === h && e.trigger == a.ActionManager.OnIntersectionEnterTrigger)c.actionManager.processTrigger(a.ActionManager.OnIntersectionEnterTrigger, a.ActionEvent.CreateNew(c)), c._intersectionsInProgress.push(f); else if (!g && h > -1 && e.trigger == a.ActionManager.OnIntersectionExitTrigger) {
      ...
      var f = (new Date).getTime(), g = this.getEngine();
      if (this.renderTargetsEnabled) {
      ...
      for (var j = 0; j < this.lights.length; j++) {
        var k = this.lights[j], l = k.getShadowGenerator();
        k.isEnabled() && l && -1 !== l.getShadowMap().getScene().textures.indexOf(l.getShadowMap()) && this._renderTargets.push(l.getShadowMap())
      }
      if (this.postProcessRenderPipelineManager.update(), this.activeCameras.length > 0)for (var m = this._renderId, n = 0; n < this.activeCameras.length; n++)this._renderId = m, this._processSubCameras(this.activeCameras[n]); else {
      ...
      for (var d = new a.Vector3(Number.MAX_VALUE, Number.MAX_VALUE, Number.MAX_VALUE), e = new a.Vector3(-Number.MAX_VALUE, -Number.MAX_VALUE, -Number.MAX_VALUE), f = 0; f < this.meshes.length; f++) {
        ...
        var h = g.getBoundingInfo().boundingBox.minimumWorld, i = g.getBoundingInfo().boundingBox.maximumWorld;
      ...
      var g = e.viewport, h = g.toGlobal(f);
      ...
      for (var e = null, f = 0; f < this.meshes.length; f++) {
        ...
        var h = g.getWorldMatrix(), i = b(h), j = g.intersects(i, d);
...
!function (a) {
  var b = function (b) {
    ...
    return __extends(c, b), Object.defineProperty(c, "BILLBOARDMODE_NONE", {
      ...
      var d = a.scale(b);
      if (c && 0 != c)this.setAbsolutePosition(this.getAbsolutePosition().add(d)); else {
      ...
      if (this._boundingInfo = this._boundingInfo || new a.BoundingInfo(this.absolutePosition, this.absolutePosition), this._boundingInfo._update(this.worldMatrixFromCache), this.subMeshes)for (var b = 0; b < this.subMeshes.length; b++) {
      ...
      if (this._cache.position.copyFrom(this.position), this._cache.scaling.copyFrom(this.scaling), this._cache.pivotMatrixUpdated = !1, this._currentRenderId = this.getScene().getRenderId(), this._isDirty = !1, a.Matrix.ScalingToRef(this.scaling.x, this.scaling.y, this.scaling.z, this._localScaling), this.rotationQuaternion ? (this.rotationQuaternion.toRotationMatrix(this._localRotation), this._cache.rotationQuaternion.copyFrom(this.rotationQuaternion)) : (a.Matrix.RotationYawPitchRollToRef(this.rotation.y, this.rotation.x, this.rotation.z, this._localRotation), this._cache.rotation.copyFrom(this.rotation)), this.infiniteDistance && !this.parent) {
        var d = this.getScene().activeCamera, e = d.getWorldMatrix(), f = new a.Vector3(e.m[12], e.m[13], e.m[14]);
      ...
      if (this._pivotMatrix.multiplyToRef(this._localScaling, this._localPivotScaling), this._localPivotScaling.multiplyToRef(this._localRotation, this._localPivotScalingRotation), this.billboardMode !== c.BILLBOARDMODE_NONE && this.getScene().activeCamera) {
        var g = this.position.clone(), h = this.getScene().activeCamera.position.clone();
      ...
      c = c || 0, d = d || 0, e = e || 0;
      var f = b.subtract(this.position), g = -Math.atan2(f.z, f.x) - Math.PI / 2, h = Math.sqrt(f.x * f.x + f.z * f.z), i = Math.atan2(f.y, h);
      ...
      if (this._submeshesOctree && this.useOctreeForCollisions) {
        var e = a.velocityWorldLength + Math.max(a.radius.x, a.radius.y, a.radius.z), f = this._submeshesOctree.intersects(a.basePointWorld, e);
        d = f.length, c = f.data
      ...
      if (this._submeshesOctree && this.useOctreeForPicking) {
        var h = a.Ray.Transform(b, this.getWorldMatrix()), i = this._submeshesOctree.intersectsRay(h);
        f = i.length, e = i.data
      ...
      if (g) {
        var m = this.getWorldMatrix(), n = a.Vector3.TransformCoordinates(b.origin, m), o = b.direction.clone();
        o.normalize(), o = o.scale(g.distance);
        var p = a.Vector3.TransformNormal(o, m), q = n.add(p);
      ...
      for (this.getPhysicsImpostor() != a.PhysicsEngine.NoImpostor && this.setPhysicsState(a.PhysicsEngine.NoImpostor), e = 0; e < this._intersectionsInProgress.length; e++) {
        var c = this._intersectionsInProgress[e], d = c._intersectionsInProgress.indexOf(this);
      ...
      if (-1 != e && this.getScene().meshes.splice(e, 1), b)for (e = 0; e < this.getScene().meshes.length; e++) {
...
!function (a) {
  ...
  var c = function (c) {
    ...
    return __extends(d, c), d.prototype.getTotalVertices = function () {
      ...
      if (!this._geometry) {
        var a = [];
        if (this._delayInfo)for (var b in this._delayInfo)a.push(b);
        return a
      }
      ...
      if (this.subMeshes)for (var d = 0; d < this.subMeshes.length; d++)this.subMeshes[d].refreshBoundingInfo();
      ...
      if (this._geometry)this._geometry.setVerticesData(b, c, d); else {
      ...
      if (this._geometry)this._geometry.setIndices(b); else {
      ...
      var d = this.getScene().getEngine(), e = this._geometry.getIndexBuffer();
      ...
      var h = 0, i = 0, j = this.getWorldMatrix();
      ...
      var n = d.getAttributeLocationByName("world0"), o = d.getAttributeLocationByName("world1"), p = d.getAttributeLocationByName("world2"), q = d.getAttributeLocationByName("world3"), r = [n, o, p, q];
      ...
      var b = this.getScene(), c = this._getInstancesRenderList(a._id);
      if (!c.mustReturn && this._geometry && this._geometry.getVertexBuffers() && this._geometry.getIndexBuffer()) {
        for (var d = 0; d < this._onBeforeRenderCallbacks.length; d++)this._onBeforeRenderCallbacks[d]();
        var e = b.getEngine(), f = null !== e.getCaps().instancedArrays && null !== c.visibleInstances[a._id], g = a.getMaterial();
        if (g && g.isReady(this, f)) {
          ...
          var i = g.getEffect(), j = e.forceWireframe || g.wireframe;
          this._bind(a, i, j);
          var k = this.getWorldMatrix();
          if (g.bind(k, this), f)this._renderWithInstances(a, j, c, i, e); else if (c.renderSelf[a._id] && this._draw(a, !j), c.visibleInstances[a._id])for (var l = 0; l < c.visibleInstances[a._id].length; l++) {
      ...
      var a = new Array, b = this.getDescendants();
      b.push(this);
      for (var c = 0; c < this.getScene().particleSystems.length; c++) {
        var d = this.getScene().particleSystems[c];
        -1 !== b.indexOf(d.emitter) && a.push(d)
      }
      return a
      ...
      var b = this, c = this, d = this.getScene();
      if (this._geometry)this._geometry.load(d); else if (c.delayLoadState === a.Engine.DELAYLOADSTATE_NOTLOADED) {
      ...
      for (var b = this.getScene().materials, c = 0; c < b.length; c++)if (b[c].id == a)return void(this.material = b[c]);
      var d = this.getScene().multiMaterials;
      for (c = 0; c < d.length; c++)if (d[c].id == a)return void(this.material = d[c])
      ...
      if (this._geometry.applyToMesh(e), a.Tools.DeepCopy(this, e, ["name", "material", "skeleton"], []), e.material = this.material, c && (e.parent = c), !d)for (var f = 0; f < this.getScene().meshes.length; f++) {
      ...
      var e = this, f = this.getScene(), g = function (a) {
        var b = document.createElement("canvas"), f = b.getContext("2d"), g = a.width, h = a.height;
        b.width = g, b.height = h, f.drawImage(a, 0, 0);
        var i = f.getImageData(0, 0, g, h).data;
        e.applyDisplacementMapFromBuffer(i, g, h, c, d)
      };
      a.Tools.LoadImage(b, g, function () {
      }, f.database)
      ...
      for (var g = this.getVerticesData(a.VertexBuffer.PositionKind), h = this.getVerticesData(a.VertexBuffer.NormalKind), i = this.getVerticesData(a.VertexBuffer.UVKind), j = a.Vector3.Zero(), k = a.Vector3.Zero(), l = a.Vector2.Zero(), m = 0; m < g.length; m += 3) {
        ...
        var n = Math.abs(l.x) * c % c | 0, o = Math.abs(l.y) * d % d | 0, p = 4 * (n + o * c), q = b[p] / 255, r = b[p + 1] / 255, s = b[p + 2] / 255, t = .3 * q + .59 * r + .11 * s;
      ...
      for (var b = this.getVerticesDataKinds(), c = [], d = [], e = [], f = !1, g = 0; g < b.length; g++) {
        var h = b[g], i = this.getVertexBuffer(h);
        h !== a.VertexBuffer.NormalKind ? (c[h] = i, d[h] = c[h].getData(), e[h] = []) : (f = i.isUpdatable(), b.splice(g, 1), g--)
      }
      var j = this.subMeshes.slice(0), k = this.getIndices(), l = this.getTotalIndices();
      for (r = 0; l > r; r++) {
        var m = k[r];
      ...
      var k = new a.Mesh(b, i), l = a.VertexData.CreateTiledGround(c, d, e, f, g, h);
      return l.applyToMesh(k, j), k
    }, d.CreateGroundFromHeightMap = function (b, c, d, e, f, g, h, i, j) {
      var k = new a.GroundMesh(b, i);
      k._subdivisions = f, k._setReady(!1);
      var l = function (b) {
        var c = document.createElement("canvas"), i = c.getContext("2d"), l = b.width, m = b.height;
        c.width = l, c.height = m, i.drawImage(b, 0, 0);
        var n = i.getImageData(0, 0, l, m).data, o = a.VertexData.CreateGroundFromHeightMap(d, e, f, g, h, n, l, m);
        o.applyToMesh(k, j), k._setReady(!0)
      };
      return a.Tools.LoadImage(c, l, function () {
      }, i.database), k
    }, d.MinMax = function (a) {
      var b = null, c = null;
      for (var d in a) {
        var e = a[d], f = e.getBoundingInfo().boundingBox;
...
!function (a) {
  var b = function (b) {
    ...
    return __extends(c, b), Object.defineProperty(c.prototype, "receiveShadows", {
      ...
      if (a.Tools.DeepCopy(this, e, ["name"], []), this.refreshBoundingInfo(), c && (e.parent = c), !d)for (var f = 0; f < this.getScene().meshes.length; f++) {
        var g = this.getScene().meshes[f];
        g.parent == this && g.clone(g.name, e)
      }
      return e.computeWorldMatrix(!0), e
  ...
  var b = function () {
    ...
    return b.prototype.getBoundingInfo = function () {
      ...
      for (var e = null, f = this.indexStart; f < this.indexStart + this.indexCount; f += 3) {
        var g = b[c[f]], h = b[c[f + 1]], i = b[c[f + 2]], j = a.intersectsTriangle(g, h, i);
...
!function (a) {
  var b = function () {
    ...
    return b.prototype.getScene = function () {
      ...
      } : this._texture._size ? {width: this._texture._size, height: this._texture._size} : {width: 0, height: 0}
      ...
      } : {width: this._texture._baseWidth, height: this._texture._baseHeight} : {width: 0, height: 0}
    ...
    }, b.prototype.releaseInternalTexture = function () {
      if (this._texture) {
...
!function (a) {
  var b = function () {
    ...
    return b.prototype.render = function (b, c) {
      ...
      var b = a.getMaterial(), c = a.getMesh();
...
!function (a) {
  var b = function () {
    ...
    return b.prototype._renderParticles = function (a, b) {
      ...
      var c = b.getMesh(), d = c.renderingGroupId || 0;
...
!function (a) {
  var b = function (b) {
    ...
    return __extends(c, b), c.prototype.resetRefreshCounter = function () {
      ...
      var b = this.getScene(), c = b.getEngine();
      ...
      var b = this.getSize(), c = new a.RenderTargetTexture(this.name, b.width, this.getScene(), this._generateMipMaps);
...
!function (a) {
  var b = function (b) {
    ...
    return __extends(c, b), c.prototype.clone = function () {
      var b = this.getSize(), c = new a.MirrorTexture(this.name, b.width, this.getScene(), this._generateMipMaps);
...
!function (a) {
  var b = function (b) {
    ...
    return __extends(c, b), c.prototype.getContext = function () {
      ...
      var b = this.getSize(), c = new a.DynamicTexture(this.name, b.width, this.getScene(), this._generateMipMaps);
...
!function (a) {
  var b = function () {
    ...
    return a.prototype.isReady = function () {
      ...
      return null
    }, a.prototype.trackCreation = function () {
    }, a.prototype._preBind = function () {
      var a = this._scene.getEngine();
      a.enableEffect(this._effect), a.setState(this.backFaceCulling)
    }, a.prototype.bind = function () {
    }, a.prototype.bindOnlyWorldMatrix = function () {
...
!function (a) {
  ...
  var d = function (c) {
    ...
    return __extends(d, c), d.prototype.needAlphaBlending = function () {
      ...
      var f = e.getEngine(), g = [], h = new a.EffectFallbacks;
      ...
      var i = !1, j = 0;
      if (e.lightsEnabled)for (var k = 0; k < e.lights.length; k++) {
        var l = e.lights[k];
        if (l.isEnabled()) {
...
!function (a) {
  var b = function () {
    ...
    return b.prototype.checkManifestFile = function () {
      ...
      var c = this, d = this, e = this.currentSceneUrl + ".manifest", f = new XMLHttpRequest, g = e + (null == e.match(/\?/) ? "?" : "&") + (new Date).getTime();
      ...
      var e = this, f = this;
      if (this.idbFactory && (this.enableSceneOffline || this.enableTexturesOffline))if (this.db)b && b(); else {
        ...
        g.onerror = function () {
          ...
          try {
            {
              e.db.createObjectStore("scenes", {keyPath: "sceneUrl"}), e.db.createObjectStore("versions", {keyPath: "sceneUrl"}), e.db.createObjectStore("textures", {keyPath: "textureUrl"})
            }
          } catch (c) {
      ...
      var d = this, e = a.Database.ReturnFullUrlLocation(b), f = function () {
      ...
      if (this.isSupported && null !== this.db) {
        ...
        f.onabort = function () {
          ...
          if (e) {
            ...
            f = g.createObjectURL(e.data, {oneTimeOnly: !0}), c.onerror = function () {
      ...
      if (this.isSupported) {
        var e = function () {
          ...
          if (f) {
            ...
            try {
              a = b.createObjectURL(f, {oneTimeOnly: !0})
            } catch (d) {
      ...
      if (this.isSupported && !this.hasReachedQuota)try {
        ...
        var f = {sceneUrl: b, data: this.manifestVersionFound}, g = e.objectStore("versions").put(f);
        g.onsuccess = function () {
        }, g.onerror = function () {
      ...
      var g = this, h = a.Database.ReturnFullUrlLocation(b), i = function () {
      ...
      if (this.isSupported) {
        ...
        i.open("GET", b, !0), e && (i.responseType = "arraybuffer"), i.onprogress = d, i.addEventListener("load", function () {
          if (200 === i.status || a.Tools.ValidateXHRData(i, e ? 6 : 1))if (h = e ? i.response : i.responseText, f.hasReachedQuota)c(h); else {
            ...
            var j;
            j = "scenes" === g ? {sceneUrl: b, data: h, version: f.manifestVersionFound} : {textureUrl: b, data: h};
            try {
      ...
      b.href = a;
      var c = a.substring(0, a.lastIndexOf("#")), d = a.substring(c.lastIndexOf("/") + 1, a.length), e = a.substring(0, a.indexOf(d, 0));
      return e
  ...
  var b = function (a, b) {
    ...
    function c(c, d, e, f) {
      ...
      this._indexBuffer = e.getEngine().createIndexBuffer(h), this._vertices = new Float32Array(d * this._vertexStrideSize), this.startDirectionFunction = function (c, d, e) {
        var f = b(g.direction1.x, g.direction2.x), h = b(g.direction1.y, g.direction2.y), i = b(g.direction1.z, g.direction2.z);
        a.Vector3.TransformNormalFromFloatsToRef(f * c, h * c, i * c, d, e)
      }, this.startPositionFunction = function (c, d) {
        var e = b(g.minEmitBox.x, g.maxEmitBox.x), f = b(g.minEmitBox.y, g.maxEmitBox.y), h = b(g.minEmitBox.z, g.maxEmitBox.z);
    ...
    return c.prototype.getCapacity = function () {
      ...
      if (b.setTexture("diffuseSampler", this.particleTexture), b.setMatrix("view", d), b.setMatrix("projection", this._scene.getProjectionMatrix()), b.setFloat4("textureMask", this.textureMask.r, this.textureMask.g, this.textureMask.b, this.textureMask.a), this._scene.clipPlane) {
        var e = this._scene.clipPlane, f = d.clone();
...
!function (a) {
  var b = function () {
    ...
    return b.prototype.isStopped = function () {
      ...
      this.currentFrame = a;
      for (var g = 0; g < this._keys.length; g++)if (this._keys[g + 1].frame >= a) {
        var h = this._keys[g].value, i = this._keys[g + 1].value, j = (a - this._keys[g].frame) / (this._keys[g + 1].frame - this._keys[g].frame);
      ...
      if (0 != this._keys[0].frame) {
        var i = {frame: 0, value: this._keys[0].value};
      ...
      var j, k = e - d, l = c * this.framePerSecond * g / 1e3;
      if (l > k && !f)h = !1, m = this._keys[this._keys.length - 1].value; else {
        var m = 0;
        if (this.loopMode != b.ANIMATIONLOOPMODE_CYCLE) {
          var n = e.toString() + d.toString();
          if (!this._offsetsCache[n]) {
            var o = this._interpolate(d, 0, b.ANIMATIONLOOPMODE_CYCLE), p = this._interpolate(e, 0, b.ANIMATIONLOOPMODE_CYCLE);
            switch (this.dataType) {
              case b.ANIMATIONTYPE_FLOAT:
      ...
      var q = l / k >> 0, r = h ? d + l % k : e, s = this._interpolate(r, q, this.loopMode, j, m);
...
!function (a) {
  var b = function () {
    ...
    return a.prototype.appendAnimations = function (a, b) {
      ...
      for (var b = this._animations, c = 0; c < b.length; c++)if (b[c].targetProperty === a)return b[c];
      return null
      ...
      for (var b = !1, c = this._animations, d = 0; d < c.length; d++) {
        var e = c[d], f = e.animate(a - this._localDelayOffset, this.fromFrame, this.toFrame, this.loopAnimation, this.speedRatio);
        b = b || f
      }
...
!function (a) {
  var b = function () {
    ...
    return b.prototype.update = function (a, c, d) {
      ...
      h.blocks = new Array;
      for (var j = new a.Vector3((c.x - b.x) / 2, (c.y - b.y) / 2, (c.z - b.z) / 2), k = 0; 2 > k; k++)for (var l = 0; 2 > l; l++)for (var m = 0; 2 > m; m++) {
        var n = b.add(j.multiplyByFloats(k, l, m)), o = b.add(j.multiplyByFloats(k + 1, l + 1, m + 1)), p = new a.OctreeBlock(n, o, e, f + 1, g, i);
...
!function (a) {
  var b = function () {
    ...
    return Object.defineProperty(b.prototype, "capacity", {
      ...
      if (this.blocks)for (var b = 0; b < this.blocks.length; b++) {
        var c = this.blocks[b];
        c.addEntry(a)
    ...
    return b.prototype.getTransformMatrices = function () {
      ...
      if (this._isDirty) {
        ...
        for (var a = 0; a < this.bones.length; a++) {
          var b = this.bones[a], c = b.getParent();
...
!function (a) {
  var b = function () {
    ...
    return b.prototype.isReusable = function () {
      ...
      b = b || this._camera;
      var d = b.getScene(), e = b.getEngine().getCaps().maxTextureSize, f = (c ? c._width : this._engine.getRenderingCanvas().width) * this._renderRatio | 0, g = (c ? c._height : this._engine.getRenderingCanvas().height) * this._renderRatio | 0;
...
!function (a) {
  var b = function () {
    ...
    return a.prototype._prepareFrame = function (a) {
      var b = this._scene.activeCamera._postProcesses, c = this._scene.activeCamera._postProcessesTakenIndices;
      ...
      var c = this._scene.activeCamera._postProcesses, d = this._scene.activeCamera._postProcessesTakenIndices;
...
!function (a) {
  var b = function () {
    ...
    return Object.defineProperty(b.prototype, "isEnabled", {
      ...
      var b = this.getEmitterPosition(), c = b.subtract(this._scene.activeCamera.position), d = c.length();
      c.normalize();
      var e = new a.Ray(this._scene.activeCamera.position, c), f = this._scene.pickWithRay(e, this.meshesSelectionPredicate, !0);
      return !f.hit || f.distance > d
    }, b.prototype.render = function () {
      if (!this._effect.isReady())return !1;
      var b = this._scene.getEngine(), c = this._scene.activeCamera.viewport, d = c.toGlobal(b);
      ...
      if (0 > h)return !1;
      h > 1 && (h = 1);
      var i = d.x + d.width / 2, j = d.y + d.height / 2, k = i - this._positionX, l = j - this._positionY;
      ...
      for (var m = 0; m < this.lensFlares.length; m++) {
        var n = this.lensFlares[m], o = i - k * n.position, p = j - l * n.position, q = n.size, r = n.size * b.getAspectRatio(this._scene.activeCamera), s = 2 * (o / d.width) - 1, t = 1 - 2 * (p / d.height), u = a.Matrix.FromValues(q / 2, 0, 0, 0, 0, r / 2, 0, 0, 0, 0, 1, 0, s, t, 0, 1);
...
!function (a) {
  ...
  var c = function () {
    ...
    return b.prototype.getNormal = function () {
      ...
      var b = this.pickedMesh.getIndices(), c = this.pickedMesh.getVerticesData(a.VertexBuffer.NormalKind), d = a.Vector3.FromArray(c, 3 * b[3 * this.faceId]), e = a.Vector3.FromArray(c, 3 * b[3 * this.faceId + 1]), f = a.Vector3.FromArray(c, 3 * b[3 * this.faceId + 2]);
      ...
      var b = this.pickedMesh.getIndices(), c = this.pickedMesh.getVerticesData(a.VertexBuffer.UVKind), d = a.Vector2.FromArray(c, 2 * b[3 * this.faceId]), e = a.Vector2.FromArray(c, 2 * b[3 * this.faceId + 1]), f = a.Vector2.FromArray(c, 2 * b[3 * this.faceId + 2]);
      ...
      this._registeredMeshes = [], this.updateBodyPosition = function (a) {
        for (var b = 0; b < this._registeredMeshes.length; b++) {
          ...
          if (c.mesh.parent === a) {
            ...
            var f = c.mesh.getAbsolutePosition(), g = a.rotation;
    ...
    return b.prototype._checkWithEpsilon = function (b) {
      ...
      switch (this.unregisterMesh(b), b.computeWorldMatrix(!0), c) {
        case a.PhysicsEngine.SphereImpostor:
          var f = b.getBoundingInfo().boundingBox, g = f.maximumWorld.x - f.minimumWorld.x, h = f.maximumWorld.y - f.minimumWorld.y, i = f.maximumWorld.z - f.minimumWorld.z, j = Math.max(this._checkWithEpsilon(g), this._checkWithEpsilon(h), this._checkWithEpsilon(i)) / 2, k = b.position.subtract(f.center);
          e = new OIMO.Body({
            type: "sphere",
            size: [j],
            ...
            world: this._world
          }), this._registeredMeshes.push({mesh: b, body: e, delta: k});
          break;
        case a.PhysicsEngine.PlaneImpostor:
        case a.PhysicsEngine.BoxImpostor:
          f = b.getBoundingInfo().boundingBox;
          var l = f.minimumWorld, m = f.maximumWorld, n = m.subtract(l), o = this._checkWithEpsilon(n.x), p = this._checkWithEpsilon(n.y), q = this._checkWithEpsilon(n.z), k = b.position.subtract(f.center);
          e = new OIMO.Body({
            type: "box",
            size: [o, p, q],
            pos: [f.center.x, f.center.y, f.center.z],
      ...
      for (var c = [], d = [], e = [], f = [], g = a[0].mesh, h = 0; h < a.length; h++) {
        var i = a[h], j = this._createBodyAsCompound(i, b, g);
      ...
      return this._registeredMeshes.push({mesh: g, body: k}), k
    }, b.prototype._createBodyAsCompound = function (b) {
      var c = null, d = b.mesh;
      switch (b.impostor) {
        case a.PhysicsEngine.SphereImpostor:
          var e = d.getBoundingInfo().boundingBox, f = e.maximumWorld.x - e.minimumWorld.x, g = e.maximumWorld.y - e.minimumWorld.y, h = e.maximumWorld.z - e.minimumWorld.z, i = Math.max(this._checkWithEpsilon(f), this._checkWithEpsilon(g), this._checkWithEpsilon(h)) / 2;
          c = {
            type: "sphere",
            size: [i, -1, -1],
        ...
        case a.PhysicsEngine.BoxImpostor:
          ...
          var j = e.minimumWorld, k = e.maximumWorld, l = k.subtract(j), m = this._checkWithEpsilon(l.x), n = this._checkWithEpsilon(l.y), o = this._checkWithEpsilon(l.z), p = d.position;
          c = {
            type: "box",
            size: [m, n, o],
            pos: [p.x, p.y, p.z],
      ...
      for (var b, c = this._registeredMeshes.length; c--;) {
        var d = this._registeredMeshes[c].body.body, e = this._registeredMeshes[c].mesh, f = this._registeredMeshes[c].delta;
        if (!d.sleeping)if (d.shapes.next) {
          ...
          var i = h.m[12], j = h.m[13], k = h.m[14];
...
!function (a) {
  var b = function (b) {
    var c = {};
    if (c.name = b.name, c.id = b.id, c.tags = a.Tags.GetTags(b), b instanceof a.PointLight)c.type = 0, c.position = b.position.asArray(); else if (b instanceof a.DirectionalLight) {
      c.type = 1;
      var d = b;
    ...
    if (!n[b.id]) {
      if (b instanceof a.Geometry.Primitives.Box)c.boxes.push(s(b)); else if (b instanceof a.Geometry.Primitives.Sphere)c.spheres.push(t(b)); else if (b instanceof a.Geometry.Primitives.Cylinder)c.cylinders.push(u(b)); else if (b instanceof a.Geometry.Primitives.Torus)c.toruses.push(v(b)); else if (b instanceof a.Geometry.Primitives.Ground)c.grounds.push(w(b)); else if (b instanceof a.Geometry.Primitives.Plane)c.planes.push(x(b)); else if (b instanceof a.Geometry.Primitives.TorusKnot)c.torusKnots.push(y(b)); else {
  ...
  var b = function () {
    ...
    return Object.defineProperty(b, "ForceFullSceneLoadingForIncremental", {
      ...
      var i = this, j = function () {
        e.database = k;
        var j = i._getPluginForFilename(d), l = function (a) {
          var g = [], i = [], k = [];
          try {
...
!function (a) {
  !function () {
    var b = function (b, c, d) {
      ...
      var f;
      if (d.mirrorPlane ? (f = new a.MirrorTexture(d.name, d.renderTargetSize, e), f._waitingRenderList = d.renderList, f.mirrorPlane = a.Plane.FromArray(d.mirrorPlane)) : d.isRenderTarget ? (f = new a.RenderTargetTexture(d.name, d.renderTargetSize, e), f._waitingRenderList = d.renderList) : f = new a.Texture(c + d.name, e), f.name = d.name, f.hasAlpha = d.hasAlpha, f.getAlphaFromRGB = d.getAlphaFromRGB, f.level = d.level, f.coordinatesIndex = d.coordinatesIndex, f.coordinatesMode = d.coordinatesMode, f.uOffset = d.uOffset, f.vOffset = d.vOffset, f.uScale = d.uScale, f.vScale = d.vScale, f.uAng = d.uAng, f.vAng = d.vAng, f.wAng = d.wAng, f.wrapU = d.wrapU, f.wrapV = d.wrapV, d.animations)for (var g = 0; g < d.animations.length; g++) {
      ...
      var e = c.getLastEntryByID(b.emitterId), f = new a.LensFlareSystem("lensFlareSystem#" + b.emitterId, e, c);
      ...
      var e = c.getLastMeshByID(b.emitterId), f = new a.ParticleSystem("particles#" + e.name, b.capacity, c);
      ...
      var d, e = a.Vector3.FromArray(b.position), f = b.lockedTargetId ? c.getLastMeshByID(b.lockedTargetId) : null;
      if ("AnaglyphArcRotateCamera" === b.type || "ArcRotateCamera" === b.type) {
        var g = b.alpha, h = b.beta, i = b.radius;
      ...
      if (e.id = b.id, a.Tags.AddTagsTo(e, b.tags), e.position = a.Vector3.FromArray(b.position), b.rotationQuaternion ? e.rotationQuaternion = a.Quaternion.FromArray(b.rotationQuaternion) : b.rotation && (e.rotation = a.Vector3.FromArray(b.rotation)), e.scaling = a.Vector3.FromArray(b.scaling), b.localMatrix ? e.setPivotMatrix(a.Matrix.FromArray(b.localMatrix)) : b.pivotMatrix && e.setPivotMatrix(a.Matrix.FromArray(b.pivotMatrix)), e.setEnabled(b.isEnabled), e.isVisible = b.isVisible, e.infiniteDistance = b.infiniteDistance, e.showBoundingBox = b.showBoundingBox, e.showSubMeshesBoundingBox = b.showSubMeshesBoundingBox, void 0 !== b.pickable && (e.isPickable = b.pickable), e.receiveShadows = b.receiveShadows, e.billboardMode = b.billboardMode, void 0 !== b.visibility && (e.visibility = b.visibility), e.checkCollisions = b.checkCollisions, e._shouldGenerateFlatShading = b.useFlatShading, b.parentId && (e._waitingParentId = b.parentId), b.delayLoadingFile ? (e.delayLoadState = a.Engine.DELAYLOADSTATE_NOTLOADED, e.delayLoadingFile = d + b.delayLoadingFile, e._boundingInfo = new a.BoundingInfo(a.Vector3.FromArray(b.boundingBoxMinimum), a.Vector3.FromArray(b.boundingBoxMaximum)), b._binaryInfo && (e._binaryInfo = b._binaryInfo), e._delayInfo = [], b.hasUVs && e._delayInfo.push(a.VertexBuffer.UVKind), b.hasUVs2 && e._delayInfo.push(a.VertexBuffer.UV2Kind), b.hasColors && e._delayInfo.push(a.VertexBuffer.ColorKind), b.hasMatricesIndices && e._delayInfo.push(a.VertexBuffer.MatricesIndicesKind), b.hasMatricesWeights && e._delayInfo.push(a.VertexBuffer.MatricesWeightsKind), e._delayLoadingFunction = A, a.SceneLoader.ForceFullSceneLoadingForIncremental && e._checkDelayState()) : A(b, e), b.materialId ? e.setMaterialByID(b.materialId) : e.material = null, b.skeletonId > -1 && (e.skeleton = c.getLastSkeletonByID(b.skeletonId)), b.physicsImpostor && (c.isPhysicsEnabled() || c.enablePhysics(), e.setPhysicsState({
        ...
        })), b.animations)for (var f = 0; f < b.animations.length; f++) {
        var g = b.animations[f];
        e.animations.push(l(g))
      }
      if (b.autoAnimate && c.beginAnimation(e, b.autoAnimateFrom, b.autoAnimateTo, b.autoAnimateLoop, 1), e.layerMask = b.layerMask && !isNaN(b.layerMask) ? Math.abs(parseInt(b.layerMask)) : 4294967295, b.instances)for (var h = 0; h < b.instances.length; h++) {
        var i = b.instances[h], j = e.createInstance(i.name);
        if (a.Tags.AddTagsTo(j, i.tags), j.position = a.Vector3.FromArray(i.position), i.rotationQuaternion ? j.rotationQuaternion = a.Quaternion.FromArray(i.rotationQuaternion) : i.rotation && (j.rotation = a.Vector3.FromArray(i.rotation)), j.scaling = a.Vector3.FromArray(i.scaling), j.checkCollisions = e.checkCollisions, b.animations)for (f = 0; f < b.animations.length; f++)g = b.animations[f], j.animations.push(l(g))
      }
      return e
    }, y = function (a, b, c) {
      b = b instanceof Array ? b : [b];
      for (var d in b)if (a.name === b[d])return c.push(a.id), !0;
      return a.parentId && -1 !== c.indexOf(a.parentId) ? (c.push(a.id), !0) : !1
    }, z = function (b, c) {
      var d = new a.VertexData, e = b.positions;
      ...
      var d = c.getScene(), e = b.geometryId;
      if (e) {
        ...
        if (b instanceof ArrayBuffer) {
          ...
          if (g.subMeshesAttrDesc && g.subMeshesAttrDesc.count > 0) {
            ...
            for (var q = 0; q < g.subMeshesAttrDesc.count; q++) {
              var r = p[5 * q + 0], s = p[5 * q + 1], t = p[5 * q + 2], u = p[5 * q + 3], v = p[5 * q + 4];
        ...
        if (b.positions && b.normals && b.indices) {
          if (c.setVerticesData(a.VertexBuffer.PositionKind, b.positions, !1), c.setVerticesData(a.VertexBuffer.NormalKind, b.normals, !1), b.uvs && c.setVerticesData(a.VertexBuffer.UVKind, b.uvs, !1), b.uvs2 && c.setVerticesData(a.VertexBuffer.UV2Kind, b.uvs2, !1), b.colors && c.setVerticesData(a.VertexBuffer.ColorKind, b.colors, !1), b.matricesIndices)if (b.matricesIndices._isExpanded)delete b.matricesIndices._isExpanded, c.setVerticesData(a.VertexBuffer.MatricesIndicesKind, b.matricesIndices, !1); else {
    ...
    a.SceneLoader.RegisterPlugin({
      extensions: ".babylon", importMesh: function (a, b, c, e, f, i, k) {
        for (var l = JSON.parse(c), m = [], n = [], o = [], p = 0; p < l.meshes.length; p++) {
          ...
          if (!a || y(q, a, o)) {
            if (a instanceof Array && delete a[a.indexOf(q.name)], q.materialId) {
              ...
              if (!r)for (var s = 0; s < l.multiMaterials.length; s++) {
            ...
            if (q.skeletonId > -1 && b.skeletons) {
              ...
              if (!w)for (var z = 0; z < l.skeletons.length; z++) {
                var A = l.skeletons[z];
        ...
        if (l.particleSystems)for (p = 0; p < l.particleSystems.length; p++) {
          var D = l.particleSystems[p];
          -1 !== o.indexOf(D.emitterId) && i.push(j(D, b, e))
        }
        return !0
      }, load: function (b, c, e) {
        var g = JSON.parse(c);
        ...
        if (g.materials)for (l = 0; l < g.materials.length; l++) {
          var y = g.materials[l];
          f(y, b, e)
        }
        if (g.multiMaterials)for (l = 0; l < g.multiMaterials.length; l++) {
          var z = g.multiMaterials[l];
          h(z, b)
        }
        if (g.skeletons)for (l = 0; l < g.skeletons.length; l++) {
          var A = g.skeletons[l];
          d(A, b)
        }
        var B = g.geometries;
        ...
        if (g.particleSystems)for (l = 0; l < g.particleSystems.length; l++) {
          var W = g.particleSystems[l];
          j(W, b, e)
        }
        if (g.lensFlareSystems)for (l = 0; l < g.lensFlareSystems.length; l++) {
          var X = g.lensFlareSystems[l];
          i(X, b, e)
        }
        if (g.shadowGenerators)for (l = 0; l < g.shadowGenerators.length; l++) {
...
!function (a) {
  var b = 0, c = function () {
    ...
    return b.FromPoints = function (c, d, e) {
      var f = e.subtract(c), g = d.subtract(c);
      ...
      for (var i = 0, j = 1, k = 2, l = 3, m = 0, n = [], o = 0; o < c.vertices.length; o++) {
        var p = a.Vector3.Dot(this.normal, c.vertices[o].pos) - this.w, q = p < -b.EPSILON ? k : p > b.EPSILON ? j : i;
        m |= q, n.push(q)
      }
      switch (m) {
        case i:
        ...
        case l:
          ...
          for (o = 0; o < c.vertices.length; o++) {
            var t = (o + 1) % c.vertices.length, u = n[o], v = n[t], w = c.vertices[o], x = c.vertices[t];
    ...
    return d.FromMesh = function (f) {
      ...
      for (var n = f.getWorldMatrix(), o = f.position.clone(), p = f.rotation.clone(), q = f.scaling.clone(), r = f.getIndices(), s = f.getVerticesData(a.VertexBuffer.PositionKind), t = f.getVerticesData(a.VertexBuffer.NormalKind), u = f.getVerticesData(a.VertexBuffer.UVKind), v = f.subMeshes, w = 0, x = v.length; x > w; w++)for (var y = v[w].indexStart, z = v[w].indexCount + v[w].indexStart; z > y; y += 3) {
        l = [];
        ...
        k = new e(l, {subMeshId: w, meshId: b, materialIndex: v[w].materialIndex}), k.plane && m.push(k)
      }
      ...
      var b = new f(this.clone().polygons), c = new f(a.clone().polygons);
      ...
      var b = new f(this.polygons), c = new f(a.polygons);
      ...
      e.invert();
      var f, g, h, i = new a.Mesh(b, c), j = [], k = [], l = [], m = [], n = a.Vector3.Zero(), o = a.Vector3.Zero(), p = a.Vector2.Zero(), q = this.polygons, r = [0, 0, 0], s = {}, t = 0, u = {};
  ...
  var b = (a.JoystickAxis, function () {
    ...
    return b.prototype.setJoystickSensibility = function (a) {
      ...
      if (this._joystickPointerID == a.pointerId) {
        ...
        var b = this.reverseLeftRight ? -1 : 1, c = b * this._deltaJoystickVector.x / this._inversedSensibility;
        ...
        var d = this.reverseUpDown ? 1 : -1, e = d * this._deltaJoystickVector.y / this._inversedSensibility;
...
!function (a) {
  var b = {
    ...
    function d(d, e, f, g) {
      ...
      var h = b.HScreenSize / 4 - b.LensSeparationDistance / 2, i = 4 * h / b.HScreenSize;
    ...
    return __extends(b, a), b.prototype._update = function () {
      ...
      var b = a.alpha / 180 * Math.PI, c = a.beta / 180 * Math.PI, d = a.gamma / 180 * Math.PI;
...
!function (a) {
  var b = {
    ...
    return __extends(d, b), d.prototype._onNewGameConnected = function (a) {
      ...
      if (this._gamepad) {
        var b = this._gamepad.leftStick, c = b.x / this.moveSensibility, d = b.y / this.moveSensibility;
        b.x = Math.abs(c) > .005 ? 0 + c : 0, b.y = Math.abs(d) > .005 ? 0 + d : 0;
        var e = a.Matrix.RotationYawPitchRoll(this.rotation.y, this.rotation.x, 0), f = a.Vector3.TransformCoordinates(new a.Vector3(b.x, 0, -b.y), e);
...
!function (a) {
  var b = function (b) {
    ...
    return __extends(c, b), c.prototype._checkInputs = function () {
      var b = a.Matrix.RotationYawPitchRoll(this.rotation.y, this.rotation.x, 0), c = a.Vector3.TransformCoordinates(this._leftjoystick.deltaPosition, b);
...
!function (a) {
  var b = function () {
    ...
    return b.prototype.set = function (b, c) {
      ...
      if (this.positions)for (var d = a.Vector3.Zero(), e = 0; e < this.positions.length; e += 3)a.Vector3.FromArrayToRef(this.positions, e, d), a.Vector3.TransformCoordinatesToRef(d, b, c), this.positions[e] = c.x, this.positions[e + 1] = c.y, this.positions[e + 2] = c.z;
      if (this.normals) {
      ...
      if (a.positions)for (this.positions || (this.positions = []), c = 0; c < a.positions.length; c++)this.positions.push(a.positions[c]);
      if (a.normals)for (this.normals || (this.normals = []), c = 0; c < a.normals.length; c++)this.normals.push(a.normals[c]);
      if (a.uvs)for (this.uvs || (this.uvs = []), c = 0; c < a.uvs.length; c++)this.uvs.push(a.uvs[c]);
      if (a.uv2s)for (this.uv2s || (this.uv2s = []), c = 0; c < a.uv2s.length; c++)this.uv2s.push(a.uv2s[c]);
      if (a.matricesIndices)for (this.matricesIndices || (this.matricesIndices = []), c = 0; c < a.matricesIndices.length; c++)this.matricesIndices.push(a.matricesIndices[c]);
      if (a.matricesWeights)for (this.matricesWeights || (this.matricesWeights = []), c = 0; c < a.matricesWeights.length; c++)this.matricesWeights.push(a.matricesWeights[c]);
      if (a.colors)for (this.colors || (this.colors = []), c = 0; c < a.colors.length; c++)this.colors.push(a.colors[c])
      ...
      var c = [new a.Vector3(0, 0, 1), new a.Vector3(0, 0, -1), new a.Vector3(1, 0, 0), new a.Vector3(-1, 0, 0), new a.Vector3(0, 1, 0), new a.Vector3(0, -1, 0)], d = [], e = [], f = [], g = [];
      b = b || 1;
      for (var h = 0; h < c.length; h++) {
        var i = c[h], j = new a.Vector3(i.y, i.z, i.x), k = a.Vector3.Cross(i, j), l = e.length / 3;
      ...
      for (var d = c / 2, e = 2 + b, f = 2 * e, g = [], h = [], i = [], j = [], k = 0; e >= k; k++) {
        for (var l = k / e, m = l * Math.PI, n = 0; f >= n; n++) {
          var o = n / f, p = o * Math.PI * 2, q = a.Matrix.RotationZ(-m), r = a.Matrix.RotationY(p), s = a.Vector3.TransformCoordinates(a.Vector3.Up(), q), t = a.Vector3.TransformCoordinates(s, r), u = t.scale(d), v = a.Vector3.Normalize(u);
          h.push(u.x, u.y, u.z), i.push(v.x, v.y, v.z), j.push(l, o)
        }
        if (k > 0)for (var w = h.length / 3, x = w - 2 * (f + 1); w > x + f + 2; x++)g.push(x), g.push(x + 1), g.push(x + f + 1), g.push(x + f + 1), g.push(x + 1), g.push(x + f + 2)
      }
      var y = new a.VertexData;
      return y.indices = g, y.positions = h, y.normals = i, y.uvs = j, y
    }, b.CreateCylinder = function (b, c, d, e, f) {
      "undefined" == typeof f && (f = 1);
      var g = c / 2, h = d / 2, i = [], j = [], k = [], l = [];
      b = b || 1, c = c || .5, d = d || 1, e = e || 16, f = f || 1, f = 1 > f ? 1 : f;
      for (var m = function (b) {
        var c = 2 * b * Math.PI / e, d = Math.cos(c), f = Math.sin(c);
        return new a.Vector3(d, 0, f)
      }, n = function (c) {
        var d = c ? g : h;
        if (0 != d) {
          var f = j.length / 3, k = new a.Vector3(0, b / 2, 0), n = new a.Vector2(.5, .5);
          for (c || (k.scaleInPlace(-1), n.x = -n.x), r = 0; e > r; r++) {
            var o = m(r), p = o.scale(d).add(k), q = new a.Vector2(o.x * n.x + .5, o.z * n.y + .5);
      ...
      }, o = new a.Vector3(0, -1, 0).scale(b / 2), p = new a.Vector3(0, 1, 0).scale(b / f), q = e + 1, r = 0; e >= r; r++)for (var s, t = m(r), u = new a.Vector2(r / e, 0), v = h, w = 0; f >= w; w++)s = t.scale(v), s.addInPlace(o.add(p.scale(w))), u.y += 1 / f, v += (g - h) / f, j.push(s.x, s.y, s.z), l.push(u.x, u.y);
      f += 1;
      for (var w = 0; f - 1 > w; w++)for (var r = 0; e >= r; r++)i.push(r * f + w), i.push((r * f + (w + f)) % (q * f)), i.push(r * f + (w + 1)), i.push(r * f + (w + 1)), i.push((r * f + (w + f)) % (q * f)), i.push((r * f + (w + f + 1)) % (q * f));
      ...
      var e = [], f = [], g = [], h = [];
      b = b || 1, c = c || .5, d = d || 16;
      for (var i = d + 1, j = 0; d >= j; j++)for (var k = j / d, l = j * Math.PI * 2 / d - Math.PI / 2, m = a.Matrix.Translation(b / 2, 0, 0).multiply(a.Matrix.RotationY(l)), n = 0; d >= n; n++) {
        var o = 1 - n / d, p = n * Math.PI * 2 / d + Math.PI, q = Math.cos(p), r = Math.sin(p), s = new a.Vector3(q, r, 0), t = s.scale(c / 2), u = new a.Vector2(k, o);
      ...
      var e, f, g = [], h = [], i = [], j = [];
      for (b = b || 1, c = c || 1, d = d || 1, e = 0; d >= e; e++)for (f = 0; d >= f; f++) {
        var k = new a.Vector3(f * b / d - b / 2, 0, (d - e) * c / d - c / 2), l = new a.Vector3(0, 1, 0);
        h.push(k.x, k.y, k.z), i.push(l.x, l.y, l.z), j.push(f / d, 1 - e / d)
      }
      for (e = 0; d > e; e++)for (f = 0; d > f; f++)g.push(f + 1 + (e + 1) * (d + 1)), g.push(f + 1 + e * (d + 1)), g.push(f + e * (d + 1)), g.push(f + (e + 1) * (d + 1)), g.push(f + 1 + (e + 1) * (d + 1)), g.push(f + e * (d + 1));
      var m = new a.VertexData;
      return m.indices = g, m.positions = h, m.normals = i, m.uvs = j, m
    }, b.CreateTiledGround = function (b, c, d, e, f, g) {
      function h(b, c, d, e) {
        var f = n.length / 3, h = g.w + 1;
        for (i = 0; i < g.h; i++)for (j = 0; j < g.w; j++) {
          var k = [f + j + i * h, f + (j + 1) + i * h, f + (j + 1) + (i + 1) * h, f + j + (i + 1) * h];
          m.push(k[1]), m.push(k[2]), m.push(k[3]), m.push(k[0]), m.push(k[1]), m.push(k[3])
        }
        var l = a.Vector3.Zero(), q = new a.Vector3(0, 1, 0);
        for (i = 0; i <= g.h; i++)for (l.z = i * (e - c) / g.h + c, j = 0; j <= g.w; j++)l.x = j * (d - b) / g.w + b, l.y = 0, n.push(l.x, l.y, l.z), o.push(q.x, q.y, q.z), p.push(j / g.w, i / g.h)
      }

      "undefined" == typeof f && (f = {w: 1, h: 1}), "undefined" == typeof g && (g = {w: 1, h: 1});
      var i, j, k, l, m = [], n = [], o = [], p = [];
      f.h = f.w < 1 ? 1 : f.h, f.w = f.w < 1 ? 1 : f.w, g.w = g.w < 1 ? 1 : g.w, g.h = g.h < 1 ? 1 : g.h;
      var q = {w: (d - b) / f.w, h: (e - c) / f.h};
      for (k = 0; k < f.h; k++)for (l = 0; l < f.w; l++)h(b + l * q.w, c + k * q.h, b + (l + 1) * q.w, c + (k + 1) * q.h);
      ...
      var j, k, l = [], m = [], n = [], o = [];
      for (j = 0; d >= j; j++)for (k = 0; d >= k; k++) {
        var p = new a.Vector3(k * b / d - b / 2, 0, (d - j) * c / d - c / 2), q = (p.x + b / 2) / b * (h - 1) | 0, r = (1 - (p.z + c / 2) / c) * (i - 1) | 0, s = 4 * (q + r * h), t = g[s] / 255, u = g[s + 1] / 255, v = g[s + 2] / 255, w = .3 * t + .59 * u + .11 * v;
        p.y = e + (f - e) * w, m.push(p.x, p.y, p.z), n.push(0, 0, 0), o.push(k / d, 1 - j / d)
      }
      for (j = 0; d > j; j++)for (k = 0; d > k; k++)l.push(k + 1 + (j + 1) * (d + 1)), l.push(k + 1 + j * (d + 1)), l.push(k + j * (d + 1)), l.push(k + (j + 1) * (d + 1)), l.push(k + 1 + (j + 1) * (d + 1)), l.push(k + j * (d + 1));
      ...
      for (var l = function (c) {
        var d = Math.cos(c), e = Math.sin(c), h = g / f * c, i = Math.cos(h), j = b * (2 + i) * .5 * d, k = b * (2 + i) * e * .5, l = b * Math.sin(h) * .5;
        return new a.Vector3(j, k, l)
      }, m = 0; d >= m; m++) {
        var n = m % d, o = n / d * 2 * f * Math.PI, p = l(o), q = l(o + .01), r = q.subtract(p), s = q.add(p), t = a.Vector3.Cross(r, s);
        s = a.Vector3.Cross(t, r), t.normalize(), s.normalize();
        for (var u = 0; e > u; u++) {
          var v = u % e, w = v / e * 2 * Math.PI, x = -c * Math.cos(w), y = c * Math.sin(w);
          i.push(p.x + x * s.x + y * t.x), i.push(p.y + x * s.y + y * t.y), i.push(p.z + x * s.z + y * t.z), k.push(m / d), k.push(u / e)
        }
      }
      for (m = 0; d > m; m++)for (u = 0; e > u; u++) {
        var z = (u + 1) % e, A = m * e + u, B = (m + 1) * e + u, C = (m + 1) * e + z, D = m * e + z;
      ...
      for (e = 0; e < c.length / 3; e++) {
        var j = c[3 * e], k = c[3 * e + 1], l = c[3 * e + 2], m = f[j], n = f[k], o = f[l], p = m.subtract(n), q = o.subtract(n);
  ...
  !function (a) {
    var b = function () {
      ...
      return a.Eval = function (b, c) {
        ...
        var d, e = b.split("||");
        for (var f in e) {
          var g = a._SimplifyNegation(e[f].trim()), h = g.split("&&");
          if (h.length > 1)for (var i = 0; i < h.length; ++i) {
...
!function (a) {
  var b = function () {
    ...
    return b.prototype._update = function () {
      ...
      for (var b in this._renderPasses)if (b === a)return this._renderPasses[a]
  ...
  var b = function () {
    ...
    return b.prototype.addEffect = function (a) {
      ...
      for (var d = a.Tools.MakeArray(b || this._cameras), e = [], f = 0; f < d.length; f++) {
        var g = d[f], h = g.name;
        -1 === this._cameras.indexOf(g) ? this._cameras[h] = g : c && e.push(f)
      }
      ...
      var e = this, f = a.Tools.MakeArray(d || this._cameras), g = null;
      for (var h in this._renderEffects)if (g = this._renderEffects[h].getPass(c), null != g)break;
      if (null !== g) {
...
!function (a) {
  var b = function () {
    function b(b) {
      ...
      var c = this._scene.getEngine(), d = a.VertexData.CreateBox(1);
    ...
    return b.prototype.reset = function () {
      ...
      if (0 != this.renderList.length && this._colorShader.isReady()) {
        ...
        for (var c = 0; c < this.renderList.length; c++) {
          var d = this.renderList.data[c], e = d.minimum, f = d.maximum, g = f.subtract(e), h = e.add(g.scale(.5)), i = a.Matrix.Scaling(g.x, g.y, g.z).multiply(a.Matrix.Translation(h.x, h.y, h.z)).multiply(d.getWorldMatrix());
  ...
  !function (b) {
    var c = function () {
      ...
      return b.GetTGAHeader = function (a) {
        ...
        var k, l, m = (15 & f.flags, f.pixel_size >> 3), n = f.width * f.height * m;
        if (h && (l = d.subarray(e, e += f.colormap_length * (f.colormap_size >> 3))), g) {
          k = new Uint8Array(n);
          for (var o, p, q, r = 0, s = new Uint8Array(m); n > e && n > r;)if (o = d[e++], p = (127 & o) + 1, 128 & o) {
        ...
        switch ((f.flags & b._ORIGIN_MASK) >> b._ORIGIN_SHIFT) {
          default:
          case b._ORIGIN_UL:
            t = 0, v = 1, y = f.width, u = 0, w = 1, x = f.height;
            break;
          case b._ORIGIN_BL:
        ...
        var z = "_getImageData" + (j ? "Grey" : "") + f.pixel_size + "bits", A = b[z](f, l, k, u, w, x, t, v, y);
        ...
        var j, k, l, m = c, n = b, o = a.width, p = a.height, q = 0, r = new Uint8Array(o * p * 4);
        for (l = d; l !== f; l += e)for (k = g; k !== i; k += h, q++)j = m[q], r[4 * (k + o * l) + 3] = 255, r[4 * (k + o * l) + 2] = n[3 * j + 0], r[4 * (k + o * l) + 1] = n[3 * j + 1], r[4 * (k + o * l) + 0] = n[3 * j + 2];
        return r
      }, b._getImageData16bits = function (a, b, c, d, e, f, g, h, i) {
        var j, k, l, m = c, n = a.width, o = a.height, p = 0, q = new Uint8Array(n * o * 4);
        for (l = d; l !== f; l += e)for (k = g; k !== i; k += h, p += 2)j = m[p + 0] + (m[p + 1] << 8), q[4 * (k + n * l) + 0] = (31744 & j) >> 7, q[4 * (k + n * l) + 1] = (992 & j) >> 2, q[4 * (k + n * l) + 2] = (31 & j) >> 3, q[4 * (k + n * l) + 3] = 32768 & j ? 0 : 255;
        return q
      }, b._getImageData24bits = function (a, b, c, d, e, f, g, h, i) {
        var j, k, l = c, m = a.width, n = a.height, o = 0, p = new Uint8Array(m * n * 4);
        for (k = d; k !== f; k += e)for (j = g; j !== i; j += h, o += 3)p[4 * (j + m * k) + 3] = 255, p[4 * (j + m * k) + 2] = l[o + 0], p[4 * (j + m * k) + 1] = l[o + 1], p[4 * (j + m * k) + 0] = l[o + 2];
        return p
      }, b._getImageData32bits = function (a, b, c, d, e, f, g, h, i) {
        var j, k, l = c, m = a.width, n = a.height, o = 0, p = new Uint8Array(m * n * 4);
        for (k = d; k !== f; k += e)for (j = g; j !== i; j += h, o += 4)p[4 * (j + m * k) + 2] = l[o + 0], p[4 * (j + m * k) + 1] = l[o + 1], p[4 * (j + m * k) + 0] = l[o + 2], p[4 * (j + m * k) + 3] = l[o + 3];
        return p
      }, b._getImageDataGrey8bits = function (a, b, c, d, e, f, g, h, i) {
        var j, k, l, m = c, n = a.width, o = a.height, p = 0, q = new Uint8Array(n * o * 4);
        for (l = d; l !== f; l += e)for (k = g; k !== i; k += h, p++)j = m[p], q[4 * (k + n * l) + 0] = j, q[4 * (k + n * l) + 1] = j, q[4 * (k + n * l) + 2] = j, q[4 * (k + n * l) + 3] = 255;
        return q
      }, b._getImageDataGrey16bits = function (a, b, c, d, e, f, g, h, i) {
        var j, k, l = c, m = a.width, n = a.height, o = 0, p = new Uint8Array(m * n * 4);
        for (k = d; k !== f; k += e)for (j = g; j !== i; j += h, o += 2)p[4 * (j + m * k) + 0] = l[o + 0], p[4 * (j + m * k) + 1] = l[o + 0], p[4 * (j + m * k) + 2] = l[o + 0], p[4 * (j + m * k) + 3] = l[o + 1];
        return p
...
!function (a) {
  !function (b) {
    ...
    var e = 542327876, f = 131072, g = 512, h = 4, i = 64, j = 131072, k = c("DXT1"), l = c("DXT3"), m = c("DXT5"), n = 31, o = 0, p = 1, q = 2, r = 3, s = 4, t = 7, u = 20, v = 21, w = 22, x = 28, y = function () {
      function b() {
      }

      return b.GetDDSInfo = function (a) {
        var b = new Int32Array(a, 0, n), c = 1;
        ...
        for (var f = new Uint8Array(d), g = new Uint8Array(e), h = 0, i = b - 1; i >= 0; i--)for (var j = 0; a > j; j++) {
          var k = c + 4 * (j + i * a);
        ...
        for (var I = H[w], J = 0; u > J; J++) {
          ...
          for (A = H[s], B = H[r], D = H[p] + 4, G = 0; F > G; ++G) {
            if (i.isRGB)24 == I ? (C = A * B * 3, E = b.GetRGBArrayBuffer(A, B, D, C, h), c.texImage2D(K, G, c.RGB, A, B, 0, c.RGB, c.UNSIGNED_BYTE, E)) : (C = A * B * 4, E = b.GetRGBAArrayBuffer(A, B, D, C, h), c.texImage2D(K, G, c.RGBA, A, B, 0, c.RGBA, c.UNSIGNED_BYTE, E)); else if (i.isLuminance) {
              var L = c.getParameter(c.UNPACK_ALIGNMENT), M = A, N = Math.floor((A + L - 1) / L) * L;
  ...
  var b = function () {
    function b() {
      this._registeredMeshes = [], this._physicsMaterials = [], this.updateBodyPosition = function (a) {
        for (var b = 0; b < this._registeredMeshes.length; b++) {
          var c = this._registeredMeshes[b];
          if (c.mesh === a || c.mesh === a.parent) {
            var d = c.body.body, e = a.getBoundingInfo().boundingBox.center;
    ...
    return b.prototype.initialize = function (a) {
      ...
      for (var c = 0; c < this._registeredMeshes.length; c++) {
        ...
        if (!d.isChild) {
          var e = d.body.position.x, f = d.body.position.y, g = d.body.position.z, h = d.delta;
      ...
      switch (this.unregisterMesh(b), b.computeWorldMatrix(!0), c) {
        case a.PhysicsEngine.SphereImpostor:
          var e = b.getBoundingInfo().boundingBox, f = e.maximumWorld.x - e.minimumWorld.x, g = e.maximumWorld.y - e.minimumWorld.y, h = e.maximumWorld.z - e.minimumWorld.z;
        ...
        case a.PhysicsEngine.BoxImpostor:
          ...
          var i = e.minimumWorld, j = e.maximumWorld, k = j.subtract(i).scale(.5);
        ...
        case a.PhysicsEngine.MeshImpostor:
          var l = b.getVerticesData(a.VertexBuffer.PositionKind), m = b.getIndices();
      ...
      var c, d;
      for (c = 0; c < this._physicsMaterials.length; c++)if (d = this._physicsMaterials[c], d.friction === a && d.restitution === b)return d;
      ...
      var h = c.getBoundingInfo().boundingBox, i = c.position.subtract(h.center), j = this._addMaterial(e, f), k = new CANNON.RigidBody(d, b, j);
      ...
      for (var c = new CANNON.Compound, d = 0; d < a.length; d++) {
        var e = a[d].mesh, f = this.registerMesh(e, a[d].impostor);
        0 == d ? c.addChild(f, new CANNON.Vec3(0, 0, 0)) : c.addChild(f, new CANNON.Vec3(e.position.x, e.position.z, e.position.y))
      }
      var g = a[0].mesh, h = this._createRigidBodyFromShape(c, g, b.mass, b.friction, b.restitution);
      return h.parts = a, h
    }, b.prototype._unbindBody = function (a) {
      for (var b = 0; b < this._registeredMeshes.length; b++) {
        var c = this._registeredMeshes[b];
...
!function (a) {
  var b = function (b) {
    ...
    return __extends(c, b), c.prototype._prepare = function () {
      ...
      var b, c = this._actionManager.getScene(), d = [{frame: 0, value: this._target[this._property]}, {
        frame: 100,
        value: this.value
      }];
      if ("number" == typeof this.value)b = a.Animation.ANIMATIONTYPE_FLOAT; else if (this.value instanceof a.Color3)b = a.Animation.ANIMATIONTYPE_COLOR3; else if (this.value instanceof a.Vector3)b = a.Animation.ANIMATIONTYPE_VECTOR3; else if (this.value instanceof a.Matrix)b = a.Animation.ANIMATIONTYPE_MATRIX; else {
...
!function (a) {
  ...
  var h = function (b) {
    ...
    return __extends(c, b), c.prototype.execute = function () {
    }, c
  }(a.Action);
  a.DoNothingAction = h;
  var i = function (a) {
...
!function (a) {
  var b = function () {
    ...
    return b.prototype.getScene = function () {
      ...
      var a = [];
      if (!this._vertexBuffers && this._delayInfo)for (var b in this._delayInfo)a.push(b); else for (b in this._vertexBuffers)a.push(b);
      return a
      ...
      var c = this._meshes, d = c.indexOf(a);
      if (-1 !== d) {
      ...
      for (var d in this._vertexBuffers)if (1 === c && this._vertexBuffers[d].create(), this._vertexBuffers[d]._buffer.references = c, d === a.VertexBuffer.PositionKind) {
...
!function (a) {
  var b = function () {
    ...
    return b.prototype._insertGamepadDOMInstructions = function () {
      ...
      for (var b in this.babylonGamepads)if (this.babylonGamepads[b].index == a.gamepad.index) {
      ...
      for (var a = navigator.getGamepads ? navigator.getGamepads() : navigator.webkitGetGamepads ? navigator.webkitGetGamepads() : [], b = 0; b < a.length; b++)if (a[b])if (a[b].index in this.babylonGamepads)this.babylonGamepads[b].browserGamepad = a[b]; else {
  ...
  var d = function () {
    ...
    return a.prototype.onleftstickchanged = function (a) {
      ...
      this._leftStick && (this.leftStick = {
        x: this.browserGamepad.axes[0],
        y: this.browserGamepad.axes[1]
      }), this._rightStick && (this.rightStick = {x: this.browserGamepad.axes[2], y: this.browserGamepad.axes[3]})
    }, a
  }();
  a.Gamepad = d;
  var e = function (a) {
  ...
  var b = function (b) {
    ...
    return __extends(c, b), c.prototype._onNewGameConnected = function (a) {
      ...
      if (this._gamepad) {
        var b = this._gamepad.leftStick, c = b.x / this.moveSensibility, d = b.y / this.moveSensibility;
        b.x = Math.abs(c) > .005 ? 0 + c : 0, b.y = Math.abs(d) > .005 ? 0 + d : 0;
        var e = this._gamepad.rightStick, f = e.x / this.angularSensibility, g = e.y / this.angularSensibility;
        e.x = Math.abs(f) > .001 ? 0 + f : 0, e.y = Math.abs(g) > .001 ? 0 + g : 0;
        var h = a.Matrix.RotationYawPitchRoll(this.rotation.y, this.rotation.x, 0), i = a.Vector3.TransformCoordinates(new a.Vector3(b.x, 0, -b.y), h);
...
!function (a) {
  var b = function (b) {
    ...
    return __extends(c, b), Object.defineProperty(c.prototype, "material", {
      ...
      var b = this.getScene().getEngine(), c = this._geometry.getIndexBuffer();
...
!function (a) {
  var b = function () {
    ...
    return b.prototype.render = function (b, c) {
      var d = this._scene, e = this._scene.getEngine(), f = null !== e.getCaps().instancedArrays && null !== c.visibleInstances;
      if (this.isReady(b, f)) {
        var g = b.getRenderingMesh(), h = b.getMaterial();
        ...
        if (f)g._renderWithInstances(b, !1, c, this._effect, e); else if (c.renderSelf[b._id] && (this._effect.setMatrix("world", g.getWorldMatrix()), g._draw(b, !0)), c.visibleInstances[b._id])for (var k = 0; k < c.visibleInstances[b._id].length; k++) {
          var l = c.visibleInstances[b._id][k];
          this._effect.setMatrix("world", l.getWorldMatrix()), g._draw(b, !0)
        }
      }
    }, b.prototype.isReady = function (b, c) {
      var d = [], e = [a.VertexBuffer.PositionKind, a.VertexBuffer.NormalKind], f = b.getMesh(), g = b.getMaterial();
      g && g.needAlphaTesting() && (d.push("#define ALPHATEST"), f.isVerticesDataPresent(a.VertexBuffer.UVKind) && (e.push(a.VertexBuffer.UVKind), d.push("#define UV1")), f.isVerticesDataPresent(a.VertexBuffer.UV2Kind) && (e.push(a.VertexBuffer.UV2Kind), d.push("#define UV2"))), f.skeleton && f.isVerticesDataPresent(a.VertexBuffer.MatricesIndicesKind) && f.isVerticesDataPresent(a.VertexBuffer.MatricesWeightsKind) && (e.push(a.VertexBuffer.MatricesIndicesKind), e.push(a.VertexBuffer.MatricesWeightsKind), d.push("#define BONES"), d.push("#define BonesPerMesh " + (f.skeleton.bones.length + 1))), c && (d.push("#define INSTANCES"), e.push("world0"), e.push("world1"), e.push("world2"), e.push("world3"));
      var h = d.join("\n");
...
/**
 * Created by thomas.slater on 11/9/14.
 */
